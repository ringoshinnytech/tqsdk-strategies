...
【策略介绍】
动量 Carry 复合轮动策略用于演示如何把“把时间序列动量和近似期限结构收益结合，筛选相对更强的品种”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 SHFE.rb2505、SHFE.cu2505、SHFE.al2505、DCE.m2505、CZCE.SR505，使用 多合约截面轮动：对品种池逐一打分，做多相对强者、做空相对弱者。
核心因子包括：20 根 K 线动量、期限结构代理因子、均线斜率。核心因子会被标准化并加权成综合得分，得分超过入场阈值时建立目标仓位，得分回落到退出阈值附近时降低或清空仓位。
...
STRATEGY_ID = 80
STRATEGY_NAME = "动量 Carry 复合轮动策略"
SYMBOLS = ["SHFE.rb2505", "SHFE.cu2505", "SHFE.al2505", "DCE.m2505", "CZCE.SR505"]
MODE = "cross_section"
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"momentum_20": 0.7, "carry_proxy": 0.6, "trend_slope": 0.4}
EPS = 1e-12
