...
【策略介绍】
协整残差突破策略用于演示如何把“把残差看作可交易状态，当残差突破长期区间时顺势持有价差”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 DCE.i2505、DCE.j2505，使用 配对/价差交易：围绕两个合约的价差或比价做均值回归或顺势扩张。
...
STRATEGY_ID = 88
STRATEGY_NAME = "协整残差突破策略"
SYMBOLS = ["DCE.i2505", "DCE.j2505"]
MODE = "pair"
PAIR_STYLE = "momentum"
KLINE_DUR = 60 * 60
DATA_LENGTH = 180
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"spread_zscore": 1.1, "spread_momentum": 0.7}
EPS = 1e-12
