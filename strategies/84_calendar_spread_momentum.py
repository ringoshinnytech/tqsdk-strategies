...
【策略介绍】
跨期价差动量策略用于演示如何把“跟踪近远月价差方向，价差持续扩张时顺势做跨期组合”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 SHFE.rb2505、SHFE.rb2510，使用 配对/价差交易：围绕两个合约的价差或比价做均值回归或顺势扩张。
...
STRATEGY_ID = 84
STRATEGY_NAME = "跨期价差动量策略"
SYMBOLS = ["SHFE.rb2505", "SHFE.rb2510"]
MODE = "pair"
PAIR_STYLE = "momentum"
KLINE_DUR = 60 * 60
DATA_LENGTH = 180
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"spread_zscore": 1.0, "spread_momentum": 0.8}
EPS = 1e-12
