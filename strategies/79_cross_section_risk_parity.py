...
【策略介绍】
截面风险平价动量策略用于演示如何把“跨品种比较风险调整后动量，偏向强趋势、低波动且流动性较好的合约”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 SHFE.rb2505、SHFE.hc2505、DCE.i2505、DCE.j2505、DCE.jm2505，使用 多合约截面轮动：对品种池逐一打分，做多相对强者、做空相对弱者。
核心因子包括：风险调整动量、低波动偏好、流动性得分。核心因子会被标准化并加权成综合得分，得分超过入场阈值时建立目标仓位，得分回落到退出阈值附近时降低或清空仓位。
...
STRATEGY_ID = 79
STRATEGY_NAME = "截面风险平价动量策略"
SYMBOLS = ["SHFE.rb2505", "SHFE.hc2505", "DCE.i2505", "DCE.j2505", "DCE.jm2505"]
MODE = "cross_section"
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"risk_adjusted_momentum": 1.1, "low_volatility": 0.6, "liquidity": 0.3}
EPS = 1e-12
