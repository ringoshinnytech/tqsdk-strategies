...
【策略介绍】
跨品种比价回归策略用于演示如何把“用豆粕/豆油比价衡量产业链相对定价，偏离历史区间后做回归”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 DCE.m2505、DCE.y2505，使用 配对/价差交易：围绕两个合约的价差或比价做均值回归或顺势扩张。
...
STRATEGY_ID = 86
STRATEGY_NAME = "跨品种比价回归策略"
SYMBOLS = ["DCE.m2505", "DCE.y2505"]
MODE = "pair"
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"spread_zscore": 1.1, "spread_momentum": 0.2}
EPS = 1e-12
