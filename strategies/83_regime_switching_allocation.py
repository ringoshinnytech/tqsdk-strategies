...
【策略介绍】
行情状态切换配置策略用于演示如何把“先判断趋势/震荡状态，再在不同状态下调整动量和波动权重”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 SHFE.rb2505、SHFE.cu2505、INE.sc2505、DCE.m2505、SHFE.au2506，使用 多合约截面轮动：对品种池逐一打分，做多相对强者、做空相对弱者。
核心因子包括：趋势/震荡状态识别、低波动偏好、短周期动量。核心因子会被标准化并加权成综合得分，得分超过入场阈值时建立目标仓位，得分回落到退出阈值附近时降低或清空仓位。
...
STRATEGY_ID = 83
STRATEGY_NAME = "行情状态切换配置策略"
SYMBOLS = ["SHFE.rb2505", "SHFE.cu2505", "INE.sc2505", "DCE.m2505", "SHFE.au2506"]
MODE = "cross_section"
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"regime_trend": 1.0, "low_volatility": 0.5, "momentum_5": 0.3}
EPS = 1e-12
