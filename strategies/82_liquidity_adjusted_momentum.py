...
【策略介绍】
流动性调整动量策略用于演示如何把“在动量排序中惩罚成交不足的合约，降低滑点和盘口冲击风险”这一交易想法落到 TqSdk 策略脚本中。
脚本默认关注 SHFE.rb2505、SHFE.cu2505、DCE.i2505、DCE.m2505、CZCE.MA505，使用 多合约截面轮动：对品种池逐一打分，做多相对强者、做空相对弱者。
核心因子包括：20 根 K 线动量、流动性得分、成交量确认。核心因子会被标准化并加权成综合得分，得分超过入场阈值时建立目标仓位，得分回落到退出阈值附近时降低或清空仓位。
...
STRATEGY_ID = 82
STRATEGY_NAME = "流动性调整动量策略"
SYMBOLS = ["SHFE.rb2505", "SHFE.cu2505", "DCE.i2505", "DCE.m2505", "CZCE.MA505"]
MODE = "cross_section"
...
BASE_VOLUME = 1
MAX_VOLUME = 1
FACTOR_WEIGHTS = {"momentum_20": 0.8, "liquidity": 0.6, "volume_confirm": 0.3}
EPS = 1e-12
